...
const NavBar = () => {
  const menuItems = (
    <>
      <li><NavLink to="/home" className="text-sm">Home</NavLink></li>
      <li><NavLink to="/apps" className="text-lg">Apps</NavLink></li>
      <li><NavLink to="/installation" className="text-lg">Installation</NavLink></li>
    </>
  );
