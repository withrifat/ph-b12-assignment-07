    ...
    <div className="bg-white rounded-3xl shadow-md hover:shadow-xl transition-shadow duration-300 p-3 sm:p-4 flex flex-col">
      ...
      <div className="flex flex-col flex-grow justify-between">
        <div>
          ...
          <div className="flex items-center justify-between mt-2 sm:mt-3 [@media(max-width:400px)]:flex-col [@media(max-width:400px)]:items-start">
            <div className="flex items-center text-[10px] sm:text-xs bg-green-50 px-2 py-1 rounded-lg">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-3 sm:h-4 sm:w-4 text-green-600 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                <path strokeLinecap="round" strokeLinejoin="round" d="M4 16v2a2 2 0 002 2h12a2 2 0 002-2v-2M7 10l5 5m0 0l5-5m-5 5V4" />
              </svg>
              {downloads}
            </div>
            <div className="flex items-center text-[10px] sm:text-xs bg-orange-50 px-2 py-1 rounded-lg mt-0 [@media(max-width:400px)]:mt-2">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-3 sm:h-4 sm:w-4 text-orange-500 mr-1" fill="currentColor" viewBox="0 0 20 20">
